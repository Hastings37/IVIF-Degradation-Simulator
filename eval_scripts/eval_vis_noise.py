...
import os
import numpy as np
from Visible.vis_noise import add_noise, DEGRADATION_LEVELS
...
for level in DEGRADATION_LEVELS:
    ...
    save_path = os.path.join(r'E:\Recurrence\IVIF-Degradation-Simulator\results\vis_noise', f'vis_noise_{level}.png')
